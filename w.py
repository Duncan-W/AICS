...
for i in range(start_at, len(all_ds), period):
    ...
    for e in entities.values():
        ...
        e.error = sklearn.metrics.mean_absolute_error(
        ...
        for nnn in range(max_nnn):
            ...
            r["diff"+str(nnn+1)] = e.error - e.augmented_error[nnn]
    ...
    # Output to file
    mae.to_csv("results_"+cur_data["filename"]+".csv")
